...
<head>
    ...
    <meta property="og:title" content="Albena Foundation for Sustainable Development">
    <meta property="og:description" content="A Yemeni charitable organization providing sponsorships and charity projects in Sana'a and Seiyun.">
    ...
    <meta name="twitter:title" content="Albena Foundation for Sustainable Development">
    <meta name="twitter:description" content="Yemeni charitable organization providing sponsorships and charity projects">
    <meta name="twitter:image" content="{{ asset('assets/images/logo.svg') }}">
                            ...
                            <div class="news-images-track" id="currentNewsImagesTrack">
                                @if(isset($news) && $news->count() > 0)
                                    @php
                                        ...
                                        $images = json_decode($firstNews->images ?? '[]', true);
                                    @endphp
                                    @if(count($images) > 0)
        ...
        <div class="footer-content">
            ...
            <div class="footer-social">
                ...
                <div class="social-icons">
                    ...
                    <a href="{{ optional($footer)->twitter_url ?? '#' }}" class="social-icon" target="_blank">
